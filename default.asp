  ...
  <button type="submit" id="login" class="btn btn-default">Entrar</button>
      ...
      <div class="tabbable tabs-left">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#a"  id="a" data-toggle="tab">Canal Masivo</a></li>
          <li><a href="#b" id="b" data-toggle="tab">Portabilidad</a></li>
          <li><a href="#c" id="c" data-toggle="tab">Segmento Negocios</a></li>
            <li><a href="#d" id="d" data-toggle="tab">Alta Normal - Clientes Nuevos</a></li>
            <li><a href="#e" id="e" data-toggle="tab">Segmento Negocio</a></li>
            <li><a href="#f" id="f" data-toggle="tab">Alta Normal - Clientes Vigentes</a></li>
            <li><a href="#g" id="g" data-toggle="tab">Operacion Fija</a></li>
            <li><a href="#h" id="h" data-toggle="tab">Segmento(Cliente Nuevo) Autonomo y Micro</a></li>
            <li><a href="#i" id="i" data-toggle="tab">Tenencia Cliente Nuevo</a></li>
            <li><a href="#j" id="j" data-toggle="tab">Persona Natural con Giro</a></li>
             <li><a href="#k" id="k" data-toggle="tab">Canal de Venta</a></li>
             <li><a href="#m" id="m" data-toggle="tab">Sub canal de Venta</a></li>
             <li><a href="#n" id="n" data-toggle="tab">Compocicion del Churn</a></li>
